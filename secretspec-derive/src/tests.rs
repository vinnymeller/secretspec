...
mod tests {
    ...
    fn test_field_type_determination() {
        ...
        assert!(is_ever_optional, "Field should be optional since it's optional in development");
    }
    ...
    fn test_default_makes_optional() {
        ...
        assert!(is_ever_optional, "Field with default should be treated as optional");
    }
}